...
import { Button, Field, Input, PasswordInput, Logo, Eyebrow } from "../components/ui";

function AuthShell({ children }) {
  return (
    <div className="h-full w-full overflow-y-auto lg:grid lg:grid-cols-[1.05fr_1fr]">
      {/* Left brand panel */}
      ...
      {/* Right form panel */}
      <main className="flex h-full items-center justify-center bg-canvas px-6 py-12">
  ...
  return (
    <AuthShell>
      ...
      <form
        ...
        onSubmit={(e) => {
          e.preventDefault();
          // TODO: replace with real Supabase auth once Sumukha's auth is ready
          console.log("sign in submitted", role);
          navigate("/");
        }}
      >
  ...
  return (
    <AuthShell>
      ...
      <form
        ...
        onSubmit={(e) => {
          e.preventDefault();
          // TODO: replace with real Supabase signup once Sumukha's auth is ready
